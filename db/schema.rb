...
ActiveRecord::Schema[7.1].define(version: 2024_06_25_013604) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "thrift_id", null: false
    t.string "size"
    t.boolean "purchased"
    t.index ["thrift_id"], name: "index_posts_on_thrift_id"
    t.index ["user_id"], name: "index_posts_on_user_id"
  end

  create_table "thrifts", force: :cascade do |t|
    t.string "store"
    t.string "address"
    t.string "phone"
    t.string "city"
